      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-8 md:flex">
            ...
            <AnimatePresence>
              {isSocialsOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute right-0 mt-2 w-48 rounded-lg bg-black/95 p-2 backdrop-blur-lg"
                >
                  {socialLinks.map((social) => (
                    <motion.a
                      ...
                      className="flex items-center gap-3 rounded-lg px-4 py-2 text-white/70 transition-colors hover:bg-white/10 hover:text-white"
                      whileHover={{ x: 4 }}
                    >
          ...
          <motion.button
            ...
            className="relative overflow-hidden rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-2.5 text-sm font-semibold text-white transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25"
          >
        ...
        <div
          ...
          } bg-black/95 p-4 backdrop-blur-lg md:hidden`}
        >
            ...
            <div className="border-t border-white/10 pt-4">
              ...
              {socialLinks.map((social) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 py-2 text-white/70 transition-colors hover:text-white"
                  onClick={() => setIsMenuOpen(false)}
                >
                  <social.icon className="h-5 w-5" />
                  {social.name}
